        ...
        */
        ...
        try
        {
            ...
            if (widthArr.length > 0 && widthArr.length == fieldArr.length && !linkToEdit)
            {
                ...
                {
                    out.println("<table style=\"width: " + tablewidth + "; table-layout: fixed;\" align=\"center\" class=\"table table-striped table-bordered table-hover\" summary=\"This table browses all dspace content\">");
                }
                else
                {
                    // Otherwise, don't constrain the width
                    out.println("<table align=\"center\" class=\"table table-striped table-bordered table-hover\" summary=\"This table browses all dspace content\">");
                }
            ...
            {
                out.println("<table width=\"" + tablewidth + "\" align=\"center\" class=\"table table-striped table-bordered table-hover\" summary=\"This table browses all dspace content\">");
            }
            else
            {
                out.println("<table align=\"center\" class=\"table table-striped table-bordered table-hover\" summary=\"This table browses all dspace content\">");
