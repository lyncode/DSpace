		...
		<div class="row">
			<div class="col-lg-12 form-group">
				<h4 id="<%=fieldName%>"><%=input.getLabel() %>
					<% if (hasWarning != null && !hasWarning) { // Hint %>
					<small>
						<%=input.getHints() %>
					</small>
				<% } %>
				...
				<div>
									...
									<%
										...
										request.setAttribute("fieldCount", defaults.length);
										request.setAttribute("confidenceValue", null);
										request.setAttribute("authorityValue", Choices.CF_UNSET);
