...
<%
			...
			for (int i = 0; i < fieldCount; i++) {
				...
				// TODO: Controlled vocabulary and Authority Control
%>
				<div class="form-group <% if (hasWarning != null && hasWarning) { %>has-error<% } %>">
					...
					<% } %>
					<input class="form-control" name="<%=fieldNameIdx %>" id="<%=fieldNameIdx %>_field" type="text" value="<%=val %>" <% if ((hasVocabulary && closedVocabulary) || readonly) { %>disabled<% } %> />
									...
									<%
										...
										request.setAttribute("isName", false);
									%>
